...
export class SetConfig{
  ...
  constructor(content:string='',headers:Array<any> = [],declineBtnCls:string='btn-light',declineBtnTxt:string='取消',approveBtnCls:string='btn-primary',approveBtnTxt:string='确定'){
    this.content=content;
